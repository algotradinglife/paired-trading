...
|---|---|---|---|---|---|
| **ag** | **0.276**（slice-1: 0.951）| **MARKET_BACKED** | **REGIME_ONLY** | 0.864 (n=9) | 1.218 (n=20) |
...
- **ag 从 PROMOTE 降为 REGIME_ONLY**：市场价下 IS 折（2024H2，n=9）净值 0.864
  ...
  画出来的。OOS 折（2025-2026，n=20）1.218 仍为正。
...
造成市场覆盖期内仍大量模型回退（修复前 ag modeled 0.69 / au 0.85）：
...
snap 占比：ag 12/29、au 17/27（大部分交易需要对齐 —— **live selector 的
